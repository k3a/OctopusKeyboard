 ...
 * @file    kptchar.h
 *
 * @brief   Character types in the KPT system (Symbian).
 *
 * @details 
 *  
 *****************************************************************************/
...
typedef char	    KPTSysCharT;    /**< System character type */
typedef uint16_t	KPTUniCharT;    /**< Internal Unicode character type */

#define KPT_TCHAR_BIT CHAR_BIT   /**< Number of bits in char */
#if defined (LINUX) || defined(MEEGO) || defined(IOS)
#define KPT_TWCHAR_BIT 32        /**< Number of bits in wchar_t */
#else
#define KPT_TWCHAR_BIT 8        /**< Number of bits in wchar_t */
#endif
#define KPT_TUNICHAR_BIT 16      /**< Number of bits in KPTUniCharT */
#define KPT_TSYSCHAR_BIT 8     /**< Number of bits in KPTSysCharT */
#define KPT_TSYSCHAR_ISWIDE 0    /**< The system character uses wide characters */
#define KPT_TSYSCHAR_ISNARROW 1  /**< The system character uses narrow characters */
