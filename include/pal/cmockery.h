...
#ifdef _WIN32
	#define KPT_DEFAULT_TEMPLATE_PATH	"..\\..\\..\\..\\..\\..\\data\\Templates\\kpttest\\"
#endif
...
#define assert_true(c) _assert_true((int)(c), #c, __FILE__, __LINE__,__func__)
// Assert that the given expression is false.
#define assert_false(c) _assert_true(!((int)(c)), #c, __FILE__, __LINE__,__func__)

// Assert that the two given integers are equal, otherwise fail.
#define assert_int_equal(a, b) _assert_int_equal(a, b, __FILE__, __LINE__,__func__)
// Assert that the two given integers are not equal, otherwise fail.
#define assert_int_not_equal(a, b) \
	_assert_int_not_equal(a, b, __FILE__, __LINE__,__func__)

// Assert that the two given strings are equal, otherwise fail.
#define assert_string_equal(a, b) \
	_assert_string_equal((const char*)a, (const char*)b, __FILE__, __LINE__,__func__)
...
#define assert_in_set(value, values, number_of_values) \
	_assert_in_set(value, values, number_of_values, __FILE__, __LINE__,__func__)
// Assert that the specified value is not within a set.
#define assert_not_in_set(value, values, number_of_values) \
	_assert_not_in_set(value, values, number_of_values, __FILE__, __LINE__,__func__)

/* ------------------------------------------------------------------
 * KPT
 *-----------------------------------------------------------------*/
// Assert that a KPTResultT means success, otherwise fail.
#define assert_succeeded(c) _assert_succeeded((KPTResultT)(c), #c, __FILE__, __LINE__,__func__)

// Assert that a KPTResultT means failure, otherwise fail.
#define assert_failed(c) _assert_failed((KPTResultT)(c), #c, __FILE__, __LINE__,__func__)

// Assert that the two KPTResultT status codes are equal, otherwise fail.
#define assert_status_equal(a, b) _assert_status_equal(a, b, __FILE__, __LINE__,__func__)

// Assert that the two given sizes are equal, otherwise fail.
#define assert_size_equal(a, b) _assert_size_equal(a, b, __FILE__, __LINE__,__func__)
/* ------------------------------------------------------------------
 * KPT
 *-----------------------------------------------------------------*/


#define Set_output_filename(szFilenameRoot)	\
	_Set_output_filename(szFilenameRoot,__FILE__)

#define Set_template_path(templatePath)	\
	_Set_template_path(templatePath,__FILE__)

#define Set_xsl_file(xslFile)	\
	_Set_xsl_file(xslFile,__FILE__)

#define Set_dtd_file(dtdFile)	\
	_Set_dtd_file(dtdFile,__FILE__)
...
#define test_free(ptr) _test_free(ptr, __FILE__, __LINE__,__func__)
...
void _assert_string_not_equal(const char * const a, const char * const b, 
                              const char *file, const int line,const char *const func);
 ...
 *-----------------------------------------------------------------*/
// Assert that a KPTResultT means success, otherwise fail.
void _assert_succeeded(const KPTResultT result, const char* const expression, 
                       const char * const file, const int line,const char *const func);

// Assert that a KPTResultT means failure, otherwise fail.
void _assert_failed(const KPTResultT result, const char* const expression, 
                    const char * const file, const int line,const char *const func);

// Assert that the two KPTResultT status codes are equal, otherwise fail.
void _assert_status_equal(const KPTResultT a, const KPTResultT b, const char * const file, 
                          const int line,const char *const func);

// Assert that the two given sizes are equal, otherwise fail.
void _assert_size_equal(const size_t a, const size_t b, const char * const file, 
                        const int line,const char *const func);
/* ------------------------------------------------------------------
 * KPT
 *-----------------------------------------------------------------*/

void _Set_output_filename(const char* szFilenameRoot,const char *const file);
void _Set_template_path(const char*templatePath,const char *const file);
void _Set_xsl_file(const char *xslFile,const char *const file);
void _Set_dtd_file(const char *dtdFile,const char *const file);


void* _test_malloc(const size_t size, const char* file, const int line);
void* _test_calloc(const size_t number_of_elements, const size_t size, 
                   const char* file, const int line);
void _test_free(void* const ptr, const char* file, const int line,const char *const func);
...
void KPTTestPrintMessage(const char* const format, ...);
void KPTTestPrintError(const char* const format, ...);
void KPTTestPrintMessageV(const char* const format, va_list args);
void KPTTestPrintErrorV(const char* const format, va_list args);
void KPTTestExit(int aQuitApplication);
