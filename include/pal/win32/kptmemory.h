 ...
 * @file    kptmemory.h
 *
 * @brief   Standard system memory allocators for windows.
 *
 * @details 
 *  
 *****************************************************************************/
...
extern "C" {
	...
	#define KPTMemStrDupNRel(aStr)								_strdup(aStr)
	#define KPTMemStrDupWRel(aStr)								_wcsdup(aStr)
	...
	#define KPTMemStrDupNDbg(aStr, aFile, aLine)				_strdup(aStr)
	#define KPTMemStrDupWDbg(aStr, aFile, aLine)				_wcsdup(aStr)
	...
	#define KPTMemStrDupN(aStr)									_strdup(aStr)
	#define KPTMemStrDupW(aStr)									_wcsdup(aStr)
